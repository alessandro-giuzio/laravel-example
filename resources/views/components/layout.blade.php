...
<body class="h-full  text-[#1b1b18] flex  items-center lg:justify-center min-h-screen flex-col ">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img class="h-8 w-8" src="https://www.agencyga.es/_astro/Logo1.CXzCzTjC_1k6C7Y.svg"
                                alt="Your Company">
                        </div>
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="h-8 w-8 rounded-full" src="https://www.giuzio.me/waffle.webp"
                                            alt="">
                                    </button>
                                </div>
                            </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Alessandro</div>
                            <div class="text-sm font-medium leading-none text-gray-400">ale@laracasts.com</div>
                        </div>
                        <button type="button"
